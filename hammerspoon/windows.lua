...
windowHotkey:bind({}, 'k', function()
  local win = hs.window.focusedWindow()
  hs.grid.set(win, {x=0, y=0, w=50, h=95}, win:screen())
end)
...
windowHotkey:bind({}, 'e', function()
  local win = hs.window.focusedWindow()
  hs.grid.set(win, {x=0, y=50, w=50, h=50}, win:screen())
end)
...
windowHotkey:bind({}, '0', function()
  local win = hs.window.focusedWindow()
  hs.grid.set(win, {x=0, y=0, w=58, h=95}, win:screen())
end)
